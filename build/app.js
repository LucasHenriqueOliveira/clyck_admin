...
appConfig.skins = [
    {name: "smart-style-0",
        logo: "styles/img/Clyck1_media.png",
...
angular.module('app.comerciante').controller('ComercianteDadosCtrl', function($scope){
...
angular.module('app.comerciante').controller('ComercianteEventosCtrl', function($scope){
